			...
			<ul class="nav ace-nav">
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								<li><a href="#" class="clearfix"> <img
										src="<%=basePath%>assets/images/avatars/avatar.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="<%=basePath%>assets/images/avatars/avatar3.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="<%=basePath%>assets/images/avatars/avatar4.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="<%=basePath%>assets/images/avatars/avatar2.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="<%=basePath%>assets/images/avatars/avatar5.png"
				...
				<li class="light-blue dropdown-modal"><a data-toggle="dropdown"
					href="#" class="dropdown-toggle"> <img class="nav-user-photo"
						src="<%=basePath%>assets/images/avatars/user.jpg"
					...
					<ul
						...
						<li><a href="<%=basePath%>logout"> <i class="ace-icon fa fa-power-off"></i>
								退出
						</a></li>
					</ul></li>
			</ul>
